...
// Edited here: commented and changed out 
...
//Edited here: Added this function 
void AirsimROSWrapper::publish_odom_tf(const nav_msgs::Odometry& odom_msg)
{
    geometry_msgs::TransformStamped odom_tf;
    odom_tf.header.frame_id = "world";
    odom_tf.child_frame_id = "base_link_gt";
...
void AirsimROSWrapper::append_static_vehicle_tf(VehicleROS* vehicle_ros, const VehicleSetting& vehicle_setting)
{
    ...
    // vehicle_ros->static_tf_msg_vec.emplace_back(vehicle_tf_msg); //edited here: commented out 
}
...
void AirsimROSWrapper::append_static_lidar_tf(VehicleROS* vehicle_ros, const std::string& lidar_name, const msr::airlib::LidarSimpleParams& lidar_setting)
{
    ...
    // vehicle_ros->static_tf_msg_vec.emplace_back(lidar_tf_msg); //edited here: commented out 
}
...
void AirsimROSWrapper::append_static_camera_tf(VehicleROS* vehicle_ros, const std::string& camera_name, const CameraSetting& camera_setting)
{
    ...
    // vehicle_ros->static_tf_msg_vec.emplace_back(static_cam_tf_body_msg); //edited here: commented out 
    // vehicle_ros->static_tf_msg_vec.emplace_back(static_cam_tf_optical_msg); //edited here: commented out 
}
...
void AirsimROSWrapper::publish_camera_tf(const ImageResponse& img_response, const ros::Time& ros_time, const std::string& frame_id, const std::string& child_frame_id)
{
    ...
    // tf_broadcaster_.sendTransform(cam_tf_body_msg); //edited here, commented out 
    // tf_broadcaster_.sendTransform(cam_tf_optical_msg); //edited here, commented out 
}
